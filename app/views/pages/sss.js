...
async function getStates() {
  var response = await fetch("https://raw.githubusercontent.com/kongvut/thai-province-data/master/api_province.json");
...
async function getDistrict(state_id) {
  ...
  var response = await fetch(
    "https://raw.githubusercontent.com/kongvut/thai-province-data/master/api_amphure.json" + state_id
  );
...
async function getAddress(district_id) {
  city_div.style.display = "none";
  var response = await fetch(
    "https://raw.githubusercontent.com/kongvut/thai-province-data/master/api_tombon.json" + district_id
  );
